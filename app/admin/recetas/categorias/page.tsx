...
export default function RecipeCategoriesAdminPage() {
  ...
  const fetchCategories = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/recipe-categories?includeInactive=true', {
        credentials: 'include'
      });
  ...
  const uploadImage = async (categorySlug: string, oldImageUrl?: string): Promise<string | null> => {
    ...
    try {
      ...
      const response = await fetch('/api/recipe-categories/upload-image', {
        method: 'POST',
        body: formData
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const endpoint = '/api/admin/recipe-categories';
  ...
  const handleDelete = async (id: string, name: string) => {
    ...
    try {
      const response = await fetch(`/api/admin/recipe-categories?id=${id}`, {
        method: 'DELETE',
        credentials: 'include'
      });
  ...
  const toggleActive = async (category: RecipeCategory) => {
    try {
    ...
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm lg:text-base">
          Administra las categorías de recetas y sus imágenes destacadas
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Con Aguacate, Desayunos, etc."
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-verde-aguacate"
                  placeholder="bg-green-500, bg-yellow-500, etc."
                />
              </div>
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                La imagen se mostrará en el hero section de la página de recetas cuando se seleccione esta categoría.
              </p>
            </div>
          </div>
