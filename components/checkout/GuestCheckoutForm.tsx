...
export function GuestCheckoutForm({ onSuccess }: GuestCheckoutFormProps) {
  ...
  const normalizePhone = (phone: string): string => {
    ...
    // Paso 2: Si el local empieza con + o tiene menos de 10 dígitos válidos, intentar extraer móvil colombiano
    // Un móvil colombiano: 3XX XXX XXXX (10 dígitos empezando en 3)
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-lg border-2 transition-all flex flex-col items-center gap-1 ${formData.paymentMethod === 'tarjeta'
