...
export function ConversionHero() {
    ...
    return (
        <section className="relative min-h-[60vh] md:min-h-[90vh] flex flex-col overflow-hidden bg-verde-bosque-900">
            ...
            <div className="flex-1 bg-gradient-to-b from-verde-bosque-900 to-verde-bosque-800 px-4 py-6 md:absolute md:inset-0 md:flex md:items-center md:bg-gradient-to-r md:from-black/70 md:via-black/40 md:to-transparent">
