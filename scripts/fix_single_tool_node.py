...
# Buscar y corregir TOOL_BuscarProductos
for node in wf["nodes"]:
    if node.get("id") == "f0b60d84-7f58-4f11-8e4d-0a4c0d7f9b11":
        ...
        print(f"✅ TOOL_BuscarProductos corregido")
...
# Guardar el payload
with open("lab-tool-fixed.json", "w", encoding="utf-8") as f:
    json.dump(payload, f, ensure_ascii=False, indent=2)

print(f"Payload creado: lab-tool-fixed.json")
